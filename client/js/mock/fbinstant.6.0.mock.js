...
var FBInstant = {
    ...
    player : {
        ...
        getPhoto: function() {
            return Utils.returnUserData('/assets/mock/profile.jpg');
        },
        getID: function() {
        ...
        getSignedPlayerInfoAsync: function() {
            return new Promise(function(resolve, reject){
                var signedPlayerInfo = {
                    getSignature: function() { return 'this_is_not_a_real_signature.signed_player_info_not_supported_in_mock_sdk'; },
    ...
    initializeAsync: function() {
        return new Promise(function(resolve, reject){
            ...
            stylesheet.href = 'css/fb/mock/mock.css';
