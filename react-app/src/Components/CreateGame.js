    ...
    window.FBInstant.context
      ...
      .then(function () {
        window.FBInstant.updateAsync({
          ...
          data: {
            myReplayData: "How to communicate",
          },
          strategy: "IMMEDIATE",
          notification: "NO_PUSH",
        })
          .then(function () {
            console.log("Update Async Finished");
  ...
  return (
    <div>
      ...
      <div className="home-wrapper">
        <div className="info">
          <div className="title">
            {window.FBInstant.context.getType() === "SOLO" && (
              <button onClick={InviteFirednd} className="create-game">
                Invite Friend
              </button>
            )}
          </div>
